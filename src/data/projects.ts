...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: '2026.06',
    description: '아버지가 운영하는 김포 법무사 사무소용 랜딩 페이지. Claude API 스트리밍으로 방문자 상담 연결, 모바일 우선 단일 페이지.',
    role: '혼자 기획부터 배포까지. Claude API 스트리밍 구현, API 키 보호용 서버 프록시 구성, Vercel 배포.',
  ...
  },
  {
    ...
    role: '혼자 만들었음. 서울 지하철 데이터 정제, 룰렛 로직 구현, Firebase 랭킹·히스토리 기능.',
    takeaway: '갈 데 없다고 맨날 싸우는 친구들 보다가 만들었습니다. Firebase를 처음 써봤고, 랭킹·히스토리 기능을 붙이면서 생각보다 사람들이 실제로 쓰는 걸 봤습니다.',
    category: 'FE',
