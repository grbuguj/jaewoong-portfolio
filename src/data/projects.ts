...
export const projects: Project[] = [
  ...
  },
  {
    id: 'kimkw-law',
    title: '법무사 AI 상담 도우미',
    subtitle: '아버지 사무소 · AI 상담 랜딩 페이지',
    date: '2026.06',
    description: '아버지가 운영하는 김포 법무사 사무소용 랜딩 페이지. 방문자가 어떻게 유입되고 어떻게 상담으로 이어지는지 구조를 설계하고, Claude와 페어프로그래밍으로 구현.',
    role: '기획·UX 설계 주도. 유입 흐름과 상담 전환 구조 설계, Claude와 페어프로그래밍으로 개발, Vercel 배포.',
    takeaway: '아버지 사무소에서 실제로 쓸 사이트를 만들었습니다. AI 상담이라고 전면에 내세우기보다 방문자가 부담 없이 상담을 신청하게 만드는 흐름을 직접 설계했습니다. 구현은 Claude와 페어프로그래밍으로 진행했고, 서버 프록시 구조나 스트리밍 처리 방식을 함께 풀어나가면서 배웠습니다.',
    category: 'FS',
  ...
  },
  {
    id: 'seouldate',
    title: '서울 랜덤 데이트',
    subtitle: '커플 서울 지하철 랜덤 데이트 앱',
    date: '2026.04',
    description: '서울 지하철 노선을 고르면 룰렛으로 랜덤 역을 뽑아주는 앱. 커플끼리 어디 갈지 못 정할 때 써먹는 용도.',
    role: '횃불이유괴단 팀 프로젝트. 서울 지하철 데이터 정제, 룰렛 로직 구현, Firebase 랭킹·히스토리 기능.',
    takeaway: '횃불이유괴단에서 같이 만든 프로젝트입니다. 갈 데 없다고 맨날 싸우는 친구들 보다가 시작했습니다. Firebase를 처음 써봤고, 랭킹·히스토리 기능을 붙이면서 생각보다 사람들이 실제로 쓰는 걸 봤습니다.',
    category: 'FE',
