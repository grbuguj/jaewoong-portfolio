...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: '2026.06',
    description: '아버지 사무소용 AI 상담 랜딩 페이지. 방문자 유입부터 상담 신청까지 흐름을 설계했습니다.',
    role: '기획·UX 설계 주도. 유입 흐름과 상담 전환 구조 설계, Claude와 페어프로그래밍으로 개발, Vercel 배포.',
    takeaway: '아버지 사무소에 실제로 쓰이는 사이트를 만들었습니다. AI를 전면에 내세우기보다 방문자가 자연스럽게 상담으로 이어지는 흐름을 설계했고, 구현은 Claude와 페어프로그래밍으로 진행했습니다. 서버 프록시 구조나 스트리밍 처리 방식도 이때 처음 다뤄봤습니다.',
    category: 'FE',
