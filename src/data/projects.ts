...
export const projects: Project[] = [
  ...
  },
  {
    id: 'kimkw-law',
    title: '법무사 AI 상담 도우미',
    subtitle: '실 클라이언트 · 법무사 사무소 전환 페이지',
    date: '2026.06',
    description: '김포 법무사 사무소의 모바일 우선 AI 상담 랜딩 페이지. Claude API 스트리밍으로 실시간 상담, 무료 예약 전환 유도.',
    role: '기획·설계·개발 전담. 클라이언트 요구사항 정의, Claude API 스트리밍 구현, 서버 프록시(API 키 보호), Vercel 배포.',
    takeaway: '처음으로 실제 클라이언트에게 의뢰받아 만든 프로젝트입니다. 김포 법무사 네이버 검색 1위 사무소의 방문자 전환율을 높이기 위한 AI 상담 랜딩 페이지로, AI를 전면에 내세우지 않고 신뢰감 있는 상담 UX를 설계했습니다. Claude API 스트리밍을 처음 구현했고, 서버 프록시로 API 키를 보호하는 구조를 직접 설계했습니다.',
    category: 'FS',
  ...
  },
  {
    id: 'seouldate',
    title: '서울 랜덤 데이트',
    subtitle: '커플 지하철역 룰렛 데이트 앱',
    date: '2026.04',
    description: '서울 지하철 노선을 고르면 룰렛이 랜덤 역을 뽑아 데이트 코스를 제안해주는 앱. 커뮤니티 히스토리·랭킹 기능 포함.',
    role: '기획·설계·개발 전담. 서울 지하철 데이터 정제, 룰렛 스핀 로직 구현, Firebase 실시간 기록·랭킹 기능 구현.',
    takeaway: '친구들이 쓸 거라 생각하고 만든 사이드 프로젝트인데, Firebase로 커뮤니티 기능(랭킹, 히스토리)을 붙이고 나서 실제로 사람들이 쓰는 걸 보았습니다. 단순한 아이디어가 서비스가 되는 경험이었습니다.',
    category: 'FE',
    stack: ['React', 'Vite', 'Firebase'],
    url: 'https://seoul-random-date.vercel.app',
    github: 'https://github.com/grbuguj/seoul-random-date',
    live: true,
  },
  {
    id: 'afw',
